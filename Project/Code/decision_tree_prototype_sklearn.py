...
features = data.iloc[:, 2:21].copy() # integer based indexing
features = np.squeeze(np.asarray(features)) # remove single dimension elements
...
scaler = StandardScaler() # mean 0, stdvar 1
